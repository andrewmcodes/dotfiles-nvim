...
- **Instant, loud feedback.** Correct → points, combo multiplier, confetti, a satisfying chord. Wrong → you see the answer and *retype it* to lock it in before moving on.
...
Clear a world to unlock the next. Progress is saved in your browser's `localStorage` — the `↺ Reset` button wipes it.
